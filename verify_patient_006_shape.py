"""Verify patient_006 artifacts match patient_001 conventions exactly."""
import json
from pathlib import Path

P1 = Path("data/synthetic/documents/patient_001")
P6 = Path("data/synthetic/documents/patient_006")
...
print(f"patient_006: {len(p6_gf['gold_flags'])} flags, {len(p6_gc['gold_contradictions'])} contradiction(s)")