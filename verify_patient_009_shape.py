"""Verify patient_009 artifacts match patient_001 conventions exactly."""
import json
from pathlib import Path

P1 = Path("data/synthetic/documents/patient_001")
P6 = Path("data/synthetic/documents/patient_009")
...
print(f"patient_009: {len(p6_gf['gold_flags'])} flags, {len(p6_gc['gold_contradictions'])} contradiction(s)")
